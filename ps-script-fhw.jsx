...
// Function to fit the smart object content to the full width and height of the document while maintaining aspect ratio
function fitContentToFullWidth(smartObjectDoc) {
    try {
        ...
        var widthRatio = docWidth / contentWidth;
        var heightRatio = docHeight / contentHeight;
        ...
        alert("Error fitting content to canvas: " + e.message + "\n\nScript by Aman Sharma");
        return false;
    }
    return true;
}
