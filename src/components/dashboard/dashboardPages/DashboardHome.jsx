...
function DashboardHome() {
  ...
  return (
    <div>
      DashboardHome Welcome to Home Page Working in Progress
      <Gauge width={100} height={100} value={60} />
      <div className="firstLayerHome flex justify-around ">
        <Card className="w-1/4 m-3">
      ...
      <div className="secondLayerHome flex justify-between w-">
        <Card className="xl:col-span-2 w-1/2 m-3">
