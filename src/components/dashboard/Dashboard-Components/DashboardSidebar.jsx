...
const DashboardSidebar = ({ onTabChange, activeTab }) => {
  const getClassNames = (tab) => {
    return `flex items-center hover:bg-slate-100 rounded-md cursor-pointer gap-2 font-medium p-1 ${
      activeTab === tab ? "bg-slate-50	" : ""
    }`;
  };

  return (
    <div className="w-1/6 bg-slate-200 h-full fixed z-10 scroll-auto">
      <div className="mainList p-2 mb-2">
        <ul>
          ...
          <li
            className={getClassNames("products")}
          ...
          <li
            className={getClassNames("customers")}
          ...
          <li
            className={getClassNames("marketing")}
          ...
          <li
            className={getClassNames("discounts")}
      ...
      <div className="salesChannelsList p-2 mb-2">
        ...
        <ul>
          <li
            className={getClassNames("onlineStore")}
            onClick={() => onTabChange("onlineStore")}
          >
            <StoreRoundedIcon fontSize="small" />
            Online Store
          </li>
          <li
            className={getClassNames("inbox")}
          ...
          <li
            className={getClassNames("metaManager")}
            onClick={() => onTabChange("metaManager")}
          >
            <FacebookRoundedIcon fontSize="small" />
            Meta Manager
          </li>
          <li
            className={getClassNames("campaignManager")}
            onClick={() => onTabChange("campaignManager")}
          >
      ...
      <div className="appsList p-2 mb-2">
        ...
        <ul>
          <li
            className={getClassNames("reviews")}
